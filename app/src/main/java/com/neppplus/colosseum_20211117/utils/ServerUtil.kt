...
//        연습 - 내 정보 가져오기 (토큰 첨부) - GET
        ...
        fun getRequestMyInfo( context: Context,  handler: JsonResponseHandler? ) {
            ...
            val urlBuilder =  "${HOST_URL}/user_info".toHttpUrlOrNull()!!.newBuilder()  // 서버주소/기능주소 까지만.
//            urlBuilder.addEncodedQueryParameter("type", type)
//            urlBuilder.addEncodedQueryParameter("value", value)
...
//        메인화면의 데이터 가져오기 (토론 주제 목록 가져오기) - GET
        ...
        fun getRequestMainInfo( context: Context,  handler: JsonResponseHandler? ) {
            ...
            val urlBuilder =  "${HOST_URL}/v2/main_info".toHttpUrlOrNull()!!.newBuilder()  // 서버주소/기능주소 까지만.
//            urlBuilder.addEncodedQueryParameter("type", type)
//            urlBuilder.addEncodedQueryParameter("value", value)
...
//                    나를 호출한 화면에게 jsonObj를 처리하는 일처리를 미루자.
        ...
        fun getRequestReplyDetail( context: Context, replyId: Int, handler: JsonResponseHandler? ) {
            ...
            val urlBuilder =  "${HOST_URL}/topic_reply".toHttpUrlOrNull()!!.newBuilder()  // 서버주소/기능주소 까지만.
